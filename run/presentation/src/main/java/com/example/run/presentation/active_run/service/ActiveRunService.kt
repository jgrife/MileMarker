...
class ActiveRunService : Service() {
    ...
    private val baseNotification by lazy {
        NotificationCompat.Builder(applicationContext, CHANNEL_ID)
            .setSilent(true)
            .setSmallIcon(com.milemarker.core.presentation.designsystem.R.drawable.logo)
    ...
    private fun stop() {
        ...
        serviceScope.cancel()
        // need to reset the Scope after a cancel, in order ot be able to use it again.
    ...
    companion object {
        ...
        const val DEEPLINK_URI = "milmarker://active_run"
