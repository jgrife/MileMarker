...
fun IntroScreen(
    ...
    GradientBackground {
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.welcome_to_mile_marker),
                color = MaterialTheme.colorScheme.onBackground,
                fontSize = 20.sp
            )
            Spacer(modifier = Modifier.height(8.dp))
            Text(
                text = stringResource(id = R.string.mile_marker_description),
...
@Composable
private fun MileMArkerLogoVertical(
    ...
    Column(
        ...
        Text(
            text = stringResource(id = R.string.mile_marker),
            fontSize = 24.sp,
